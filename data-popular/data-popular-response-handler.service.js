/*
 *  Response Handler Service In Popular Data Services
 */
...
(function() {
    ...
    angular
        .module('data.popular')
        .factory('popularResponseHandlerService', popularResponseHandlerService);

    popularResponseHandlerService.$inject = [
        'popularExceptionCatcherService',
        'Logger'
    ];

    function popularResponseHandlerService(popularExceptionCatcherService, Logger) {
        // Logger object
        var logger = Logger.getInstance('app - data - popular - response - handler');
        var service = {
        ...
        function requestFailed(error) {
            var parsedError = popularExceptionCatcherService.catcher(error);

            if (!(parsedError && parsedError instanceof popularExceptionCatcherService.error)) {
                ...
                logger.error('requestFailed', 'Request Failed: Popular Error!');
