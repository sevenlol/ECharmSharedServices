/*
 *  Response Handler Service In Q & A Data Services
 */
...
(function() {
    ...
    function askdoctorResponseHandlerService(askdoctorExceptionCatcherService, Logger) {
        ...
        function requestFailed(error) {
            var parsedError = askdoctorExceptionCatcherService.catcher(error);

            if (!(parsedError && parsedError instanceof askdoctorExceptionCatcherService.error)) {
                ...
                logger.error('requestFailed', 'Request Failed: Askdoctor Error!');
