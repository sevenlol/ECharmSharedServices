/*
 *  Response Handler Service In Favorite Data Services
 */
...
(function() {
    ...
    angular
        ...
        .factory('favoriteResponseHandlerService', favoriteResponseHandlerService);

    favoriteResponseHandlerService.$inject = [
        'favoriteExceptionCatcherService',
        'Logger'
    ];

    function favoriteResponseHandlerService(favoriteExceptionCatcherService, Logger) {
        // Logger object
        var logger = Logger.getInstance('app - data - favorite - response - handler');
        var service = {
        ...
        function requestFailed(error) {
            var parsedError = favoriteExceptionCatcherService.catcher(error);

            if (!(parsedError && parsedError instanceof favoriteExceptionCatcherService.error)) {
                ...
                logger.error('requestFailed', 'Request Failed: Favorite Error!');
