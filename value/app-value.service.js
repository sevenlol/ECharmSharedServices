...
function valueService(SERVER_URL_AUTH, SERVER_URL_BLOG, SERVER_URL_ASKDOCTOR, SERVER_URL_ACCOUNT, SERVER_URL_MEMBER,
                      SERVER_URL_FAVORITE, HTTP_METHOD_GET, HTTP_METHOD_POST, HTTP_METHOD_PUT, HTTP_METHOD_PATCH,
                      HTTP_METHOD_DELETE, USER_TYPE_USER, USER_TYPE_DOCTOR, USER_TYPE_ADMIN, ACCOUNT_TYPE_ECHARM) {
    var service = {
        /* Server */
        SERVER_URL : {
